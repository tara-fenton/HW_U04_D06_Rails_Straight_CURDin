...
Cheese.create!([
  { name: 'Point Reyes Bay Blue',
    milk_type: 'cow',
    image_url: 'http://www.specialtyfood.com/media/uploads/articles/NP_PointReyes_BayBlue_72dpi.jpg',
      description: 'Inspired by the sheer natural beauty of our coastal climate and locale, Bay Blue is a rustic-style blue cheese reminiscent of Stilton. It is known for its mellow flavor and sweet, salted-caramel finish.'
  },
